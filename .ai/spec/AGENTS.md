...
The `.ai/spec/` folder is the central repository for:
...
1. Create a new spec file at `.ai/spec/<module-name>.md`
...
This ensures the `.ai/spec/` folder remains a reliable reference for understanding module behavior and evolution over time.
